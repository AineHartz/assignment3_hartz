...
public class gen_SLList 
{
	...
	public void listAdd(Object p)
	{
		...
		gen_SLNode node = new gen_SLNode(p);
	...
	{
		int i = 0;
		gen_SLNode previous = head;
		gen_SLNode temp = new gen_SLNode(null);
